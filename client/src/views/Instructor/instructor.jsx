...
const Instructor = () => {
  ...
  useEffect(() => {
    ...
    const fetchReviews = async () => {
      const reviewsResponse = await dispatch(getReviews_user());
      setUserReviews(reviewsResponse); // Guardar las reviews en el estado
    };
  
    const fetchComments = async () => {
      const commentsResponse = await dispatch(getReviews());
      setUserComments(commentsResponse); // Guardar los comentarios en el estado
    };
    ...
    <div className={styles.container}>
      ...
      <div className={styles.cardContainer}>
        {users?.map((user) => {
          ...
          const reviewComments = userComments.filter((comment) => userReviewIDs.includes(comment.reviews_id));
            ...
            return (
              <div className={styles.card}>
                ...
                <div className={styles.card_subtitle}>
                  <h2 className={`${styles.info} info`}>Languages:</h2>
