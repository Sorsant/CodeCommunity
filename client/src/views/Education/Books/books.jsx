  ...
  return (
    <div className={styles.container}>
      <div className={styles.book}>
        <div className={styles.titleContainer}>
          <h4 className={styles.titleStudent}>Clean JavaScript</h4>
          <a className={styles.a} href="https://drive.google.com/file/d/1-kcphyfUwRx_RwgPyC3QMG8BMjfDXncO/view?usp=sharing">
            Go to Book
          </a>
          <img className={styles.image} src={Book1} alt="Front Page" />
        </div>
      ...
      <div className={styles.book}>
        <div className={styles.titleContainer}>
          <h4 className={styles.titleStudent}>Código Limpio</h4>
          <a className={styles.a} href="https://drive.google.com/file/d/1enp4-q0ITDeindPez9eIF4z4jwx94T9Y/view?usp=sharing">
            Go to Book
          </a>
          <img className={styles.image} src={Book2} alt="Front Page" />
        </div>
      ...
      <div className={styles.book}>
        <div className={styles.titleContainer}>
          <h4 className={styles.titleStudent}>Sumérgete en los Patrones de Diseño</h4>
          <a className={styles.a} href="https://drive.google.com/file/d/13QIosOrdOKjVcQn2hzHU41K4Qz9No3sn/view?usp=sharing">
            Go to Book
          </a>
          <img className={styles.image} src={Book3} alt="Front Page" />
        </div>
        <h5 className={styles.paragraph}>
          Este libro contiene las descripciones de 22 patrones de diseño clásicos formulados...
        </h5>
      </div>
      <div className={styles.book}>
        <div className={styles.titleContainer}>
          <h4 className={styles.titleStudent}>El programador pragmático</h4>
          <a className={styles.a} href="https://drive.google.com/file/d/11DrBXC8Rcpsi3drtAL7s1FIRHw3d9Ha9/view?usp=sharing">
            Go to Book
          </a>
          <img className={styles.image} src={Book4} alt="Front Page" />
        </div>
        <h5 className={styles.paragraph}>
          Este libro le dice cómo programar de una manera que pueda seguir...
        </h5>
      </div>
    </div>
  );
