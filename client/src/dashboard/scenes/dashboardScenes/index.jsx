...
import GeographyChart from "../../componentsDash/GeographyChart";
    ...
    <Box m="20px">
      ...
      >
        ...
        >
          <StatBox
            title="431,225"
            subtitle="Premium Users Obtained"
            progress="0.50"
            increase="+21%"
            icon={
              <PointOfSaleIcon
        ...
        >
          <StatBox
            title="1,325,134"
            subtitle="Traffic received to Post"
            progress="0.80"
            increase="+43%"
            icon={
              <TrafficIcon
        ...
        >
          ...
          >
            <Typography color={colors.grey[100]} variant="h5" fontWeight="600">
              Recent Transactions User Premium
            </Typography>
          </Box>
