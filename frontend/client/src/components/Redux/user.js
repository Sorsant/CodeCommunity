...
const getUser = createAsyncThunk('http://localhost:5000/users/me', async (_, thunkAPI) => {
	try {
...
export const logout = createAsyncThunk('http://localhost:5000/users/logout', async (_, thunkAPI) => {
	try {
