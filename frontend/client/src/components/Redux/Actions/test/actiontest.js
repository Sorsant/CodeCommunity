...
// 		const res = await axios.post('https://codecommunity-production.up.railway.app/api/users/register', body, {
// 			headers: {
...
// 		const res = await axios.post('https://codecommunity-production.up.railway.app/api/users/login', body, {
// 			headers: {
// 				Accept: 'application/json',
// 				'Content-Type': 'application/json',
// 			},
